...
export interface AdminPwaBucketConstructProps {
}

export class AdminPwaBucketConstruct extends Construct {
    public readonly bucket: s3.Bucket;
    constructor(scope: Construct, id: string, props?: AdminPwaBucketConstructProps) {
        super(scope, id);
        // Create an S3 bucket where the PWA will be stored
        this.bucket = new s3.Bucket(this, 'AdminPwaBucket', {
